...
const Style = ({
  ...
  var _styles$columnGap, _styles$rowGap, _styles$social$gap;
  const {
    styles = {}
  } = attributes || {};
  const mainSl = `#${id}`;
  ...
  const avatarShadow = (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(styles?.avatar?.shadow);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${cardSl}::before {
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.card?.radius)};
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.card?.hoverBg)}
		}

		${avatarSl} {
			width: ${styles?.avatar?.size || '210px'};
			height: ${styles?.avatar?.size || '210px'};
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.avatar?.padding)};
			border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.avatar?.radius)};
		...
		${socialListSl} {
			gap: ${(_styles$social$gap = styles?.social?.gap) !== null && _styles$social$gap !== void 0 ? _styles$social$gap : 6}px;
		...
		${socialLinkSl} {
			...
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.social?.iconBg)}
		}
		${socialLinkSl} svg {
		...
		${cardSl}:hover ${socialLinkRel} {
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.social?.iconHoverBg)}
		}
...
const OneCard = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "tsb_otc_section"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "tsb_otc_container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "tsb_otc_cards"
  }, profiles.map((profile, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "tsb_otc_member_card",
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "tsb_otc_avatar"
...
document.addEventListener('DOMContentLoaded', () => {
  const blockEls = document.querySelectorAll('.wp-block-tsb-our-team-cards-pro');
